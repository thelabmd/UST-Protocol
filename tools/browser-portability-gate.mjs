...
const EXPECTED_KINDS_TOTAL = 47, EXPECTED_KINDS_NOT_RUN = 41;   // measured 2026-08-14 — round 216 adds `map-currency`, classified NOT-RUN: its input is a signed document plus a consumer trust configuration, so it needs the Ed25519 faculty the browser build refuses by name (46/40 on 2026-08-13, 45/39 earlier that day, 44/38 on 2026-08-10)
