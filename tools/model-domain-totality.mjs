...
const EXPECTED_SECTIONS = 44;   // 43 → 44: F.5r (#122, rev73) — producer-side fork: приватная голова слепа к своей же вилке.   // 42 → 43: F.5q added (#120, rev71) — the ANCHORING axis, where "dark" is a universal claim needing a declared domain.   // 40 → 41: F.5o added (#102, rev98) — the SERVING axis of the independence closure, the one normative surface that rendered a verdict and had no object in this model.   // 34 → 35: F.5c.1 added (#95, rev86) — the anchor seam, where F.3's delegated membership assumption is paid for
