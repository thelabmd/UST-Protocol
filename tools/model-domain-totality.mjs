...
const EXPECTED_SECTIONS = 42;   // 40 → 41: F.5o added (#102, rev98) — the SERVING axis of the independence closure, the one normative surface that rendered a verdict and had no object in this model.   // 34 → 35: F.5c.1 added (#95, rev86) — the anchor seam, where F.3's delegated membership assumption is paid for
