...
- **144 deterministic conformance vectors** plus a behavioral conformance runner (**790 registered checks**), and the reference impl passes them (one known note: duplicate-key
...
- **130 recorded rounds** in `CHANGELOG.md`, carrying the reference-checker from `rev3` to `rev72`. The adversarial
