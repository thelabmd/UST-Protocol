...
- **133 deterministic conformance vectors** plus a behavioral conformance runner (**762 registered checks**), and the reference impl passes them (one known note: duplicate-key
...
- **122 recorded rounds** in `CHANGELOG.md`, carrying the reference-checker from `rev3` to `rev65`. The adversarial
