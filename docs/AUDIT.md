...
- **139 deterministic conformance vectors** plus a behavioral conformance runner (**774 registered checks**), and the reference impl passes them (one known note: duplicate-key
...
- **126 recorded rounds** in `CHANGELOG.md`, carrying the reference-checker from `rev3` to `rev68`. The adversarial
