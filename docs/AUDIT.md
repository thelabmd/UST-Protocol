...
- **228 deterministic conformance vectors** plus a behavioral conformance runner (**955 registered checks**), and the reference impl passes them (one known note: duplicate-key
...
- **194 recorded rounds** in `CHANGELOG.md`, carrying the reference-checker from `rev3` to `rev93`. The adversarial
