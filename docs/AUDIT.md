...
- **189 deterministic conformance vectors** plus a behavioral conformance runner (**865 registered checks**), and the reference impl passes them (one known note: duplicate-key
