...
- **145 deterministic conformance vectors** plus a behavioral conformance runner (**794 registered checks**), and the reference impl passes them (one known note: duplicate-key
...
- **132 recorded rounds** in `CHANGELOG.md`, carrying the reference-checker from `rev3` to `rev74`. The adversarial
