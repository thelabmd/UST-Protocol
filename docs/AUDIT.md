...
- **188 deterministic conformance vectors** plus a behavioral conformance runner (**864 registered checks**), and the reference impl passes them (one known note: duplicate-key
