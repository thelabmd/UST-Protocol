...
- **159 deterministic conformance vectors** plus a behavioral conformance runner (**814 registered checks**), and the reference impl passes them (one known note: duplicate-key
...
- **144 recorded rounds** in `CHANGELOG.md`, carrying the reference-checker from `rev3` to `rev84`. The adversarial
