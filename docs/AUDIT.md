...
- **140 deterministic conformance vectors** plus a behavioral conformance runner (**780 registered checks**), and the reference impl passes them (one known note: duplicate-key
...
- **128 recorded rounds** in `CHANGELOG.md`, carrying the reference-checker from `rev3` to `rev70`. The adversarial
