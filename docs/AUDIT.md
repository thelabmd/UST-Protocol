...
- **166 deterministic conformance vectors** plus a behavioral conformance runner (**823 registered checks**), and the reference impl passes them (one known note: duplicate-key
...
- **148 recorded rounds** in `CHANGELOG.md`, carrying the reference-checker from `rev3` to `rev90`. The adversarial
