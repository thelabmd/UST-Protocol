...
- **250 deterministic conformance vectors** plus a behavioral conformance runner (**994 registered checks**), and the reference impl passes them (one known note: duplicate-key
...
- **207 recorded rounds** in `CHANGELOG.md`, carrying the reference-checker from `rev3` to `rev94`. The adversarial
