...
export const REFERENCE_CHECKER_VERSION = '1.0.0-rc.37-L1-rev79';
...
const reducePackage = (x) => {
  try { if (x === null || typeof x !== 'object' || Array.isArray(x)) return { error: 'E-ENCODE' }; } catch { return { error: 'E-ENCODE' }; }   // round-51 — `Array.isArray` THROWS on a REVOKED Proxy; guard the first type-probe (totality class)
