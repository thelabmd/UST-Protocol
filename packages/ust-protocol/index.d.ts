...
export function checkAuthorityProofBytes(packageBytes: unknown, configBytes: unknown): { err: unknown };
...
export function verifyAuthorityBundle(inputs?: unknown, config?: unknown): Record<string, unknown>;
