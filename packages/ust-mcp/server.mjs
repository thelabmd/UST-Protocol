...
const UA = 'ust/1.0 (ust-mcp/1.0.0-rc.63; +https://github.com/thelabmd/UST-Protocol)';
...
let VERSION = 'unknown';
try { VERSION = JSON.parse(readFileSync(new URL('./package.json', import.meta.url), 'utf8')).version; } catch { /* leave 'unknown' */ }
