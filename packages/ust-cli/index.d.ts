...
export function buildWitnessLog(genesisText: unknown, anchors?: unknown, priorLogText?: unknown): Record<string, unknown>;
export function buildWorkerScript(genesisText: unknown, keylogText?: unknown, witnessText?: unknown, cadenceText?: unknown): Record<string, unknown>;
export function buildWranglerProject(arg0?: unknown): Record<string, unknown>;
export const CEREMONY_STEPS: unknown;
export function ceremonyMap(current?: unknown): Record<string, unknown>;
...
export function closeReader(rl?: unknown): Record<string, unknown>;
export function cmdCadence(): Promise<Record<string, unknown>>;
export function cmdRotate(): Promise<Record<string, unknown>>;
...
export function confirmLive(arg0?: unknown): Promise<Record<string, unknown>>;
...
export function invocation(): Record<string, unknown>;
...
export function manualDnsGuide(domain: unknown, txt: unknown): Record<string, unknown>;
export function manualServingGuide(domain: unknown, outDir: unknown): Record<string, unknown>;
export function offlineHandoff(arg0: unknown): unknown[];
export function openReader(createInterface: unknown): Record<string, unknown>;
export function parseKeylogRaw(raw: unknown): unknown;
export function parseLogRaw(raw: unknown, label?: unknown): { err: unknown };
...
export function stageSummary(arg0?: unknown): Record<string, unknown>;
export const STREAM_VALUE_FLAGS: unknown;
export function validateKeylogChain(genesisDoc: unknown, entries: unknown): Record<string, unknown>;
export function validatePublishInputs(arg0?: unknown): { doc: unknown; genHash: unknown; entries: unknown };
export function verdictOf(checks: unknown): Record<string, unknown>;
export function verifyRaw(raw?: unknown, opts?: unknown): { verdict: unknown; doc: unknown; text: unknown };
