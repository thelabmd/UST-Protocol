...
export function askHidden(q: unknown, fallbackAsk: unknown): Promise<unknown>;
export function attestDiscovery(arg0?: unknown): Promise<unknown>;
export function attestMirror(arg0?: unknown): Promise<unknown>;
export function buildCeremony(arg0?: unknown): Promise<unknown>;
export function buildWitnessLog(genesisText: unknown, anchors?: unknown, priorLogText?: unknown): unknown;
export function buildWorkerScript(genesisText: unknown, keylogText?: unknown, witnessText?: unknown, cadenceText?: unknown): unknown;
export function buildWranglerProject(arg0?: unknown): unknown;
...
export function cfApexSteps(arg0?: unknown): Promise<unknown>;
export function cfPublish(arg0?: unknown): Promise<unknown>;
export function cfUpsert(arg0?: unknown): Promise<unknown>;
...
export function cmdRotate(): Promise<unknown>;
export function collectServed(arg0?: unknown): Promise<unknown>;
export function confirmLive(arg0?: unknown): Promise<unknown>;
export function contextFor(doc?: unknown): unknown;
...
export function dohConfirmTxt(arg0?: unknown): Promise<unknown>;
export function encryptKey(pkcs8: unknown, pass: unknown): unknown;
...
export function logToRekor(rootHex: unknown, arg1?: unknown): Promise<unknown>;
...
export function rotateKeylog(arg0?: unknown): Promise<unknown>;
export function scanDupes(text: unknown): unknown;
...
export function validateKeylogChain(genesisDoc: unknown, entries: unknown): unknown;
export function validatePublishInputs(arg0?: unknown): unknown;
export function verdictOf(checks: unknown): unknown;
...
export function wranglerDeploy(arg0?: unknown): Promise<unknown>;
