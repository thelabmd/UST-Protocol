...
export function buildWorkerScript(genesisText: unknown, keylogText?: unknown, witnessText?: unknown, cadenceText?: unknown, profileText?: unknown): string;
...
export function cmdKeyCheck(): Promise<string>;
export function cmdReroot(): Promise<string>;
export function cmdRotate(): Promise<string>;
export function collectServed(arg0?: unknown): Promise<{ genesisText: unknown; keylogText: unknown; cadenceText: unknown; witnessText: unknown; profileText: unknown }>;
...
export function decryptKeyShape(b64?: unknown): string;
...
export const PROFILE_ORIGIN: unknown;
export const PROFILE_PATH: unknown;
export function proveWrittenKey(path: unknown, expectedPub: unknown, opts?: unknown): string;
...
export function rootSignerFrom(pkcs8: unknown, rootPubB64url: unknown): Promise<string>;
